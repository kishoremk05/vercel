...
const AuthPage: React.FC<AuthPageProps> = ({ onAuthSuccess }) => {
  ...
  return (
    <>
      <SEO
        title="Login or Sign Up | ReputationFlow360"
        description="Securely log in or create your ReputationFlow360 account. Start automating customer feedback collection and managing your business reputation today."
        canonical="https://reputationflow360.com/auth"
        keywords="login, sign up, customer feedback login, reputation management login, review automation account"
      />
