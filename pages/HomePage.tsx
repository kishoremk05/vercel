        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-gray-600 leading-relaxed">
                Upload your customer list and send personalized survey requests
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-gray-600 leading-relaxed">
                Happy customers get directed to review sites. Unhappy ones give
                private feedback you can act on.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="text-center mt-12">
            <p className="text-sm text-gray-600">
              All plans include unlimited users, feedback collection, and review
              management
            </p>
          </div>
        </div>
      ...
      <section className="py-16 bg-gray-900/90 text-white">
        <div className="mx-auto max-w-4xl px-6 text-center space-y-8">
          ...
          <p className="text-base text-gray-300">
            Start collecting more reviews and valuable feedback today. No credit
            card required.
          </p>
          <button
            onClick={onTryFree}
