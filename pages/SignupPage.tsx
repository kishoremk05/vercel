...
const SignupPage: React.FC<SignupPageProps> = ({ onSignupSuccess }) => {
  ...
  return (
    <>
      <SEO
        title="Sign Up | ReputationFlow360"
        description="Create your ReputationFlow360 account and start automating customer feedback collection. Get started with review automation and reputation management today."
        canonical="https://reputationflow360.com/signup"
        keywords="sign up, create account, register, reputation management signup, review automation registration"
      />
